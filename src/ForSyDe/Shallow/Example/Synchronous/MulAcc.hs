...
-- | 'make_sconstant' is the SystemC equivalent to 'sourceSY' with a dummy signal generation function
make_sconstant = sourceSY $ (+) 0
constant1      = make_sconstant 3

-- | 'make_ssource' is the SystemC equivalent to 'sourceSY' in Haskell
